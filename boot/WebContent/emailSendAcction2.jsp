...
<%
	...
	if(userID == null){
		...
		script.println("location.href = 'userLogin.jsp'"); //다시 뒷쪽으로 보내주는 함수
		script.println("</script>");
		script.close();
		return;
	}
	...
	if(emailChecked == true) {
		...
		script.println("location.href = 'straps.jsp");
		script.println("</script>");
		script.close();
		return;
	}
